...
cls
echo.
echo       cfmlprojects-keyring menu
REM echo       usage: cfmlprojects-keyring.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: cfmlprojects-keyring.bat stop
goto end
::
:stopServer
